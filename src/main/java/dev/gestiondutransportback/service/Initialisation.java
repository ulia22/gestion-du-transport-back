...
public class Initialisation {
	...
	public void initVehicule(){
		if(vehiculeServ.count()==0){
			Stream.of(new Vehicule("010203", "https://www.alexandre-marine.fr/s/cc_images/cache_2436147775.jpg?t=1395164051", Statut.EN_SERVICE , 4, modeleServ.findOne(1) )).forEach(vehiculeServ::save);
		}
	}
